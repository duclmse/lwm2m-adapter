...
public class ClientServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (req.getPathInfo() == null) {
            ...
            for (Iterator<Registration> iterator = server.getRegistrationService()
                .getAllRegistrations(); iterator.hasNext(); ) {
        ...
        try {
            ...
            if (registration != null) {
                ...
                ContentFormat contentFormat =
                    contentFormatParam != null ? ContentFormat.fromName(contentFormatParam.toUpperCase()) : null;
        ...
        try {
            ...
            if (registration != null) {
                if (path.length >= 3 && "attributes".equals(path[path.length - 1])) {
                    ...
                    if (replaceParam != null) replace = Boolean.valueOf(replaceParam);
    ...
    private void processDeviceResponse(
        HttpServletRequest req, HttpServletResponse resp, LwM2mResponse cResponse
    ) throws IOException {
        if (cResponse == null) {
